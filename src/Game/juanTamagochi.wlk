...
object juanTamagochi {
	...
	method configurarPersonaje(){
		...
		game.onTick(2000,"disminuye humor cada 20 seg",{statsDelJuego.humorDePersonaje().modificarCantidad(-5)})
		game.onTick(3000,"disminuye higiene cada 30 seg",{statsDelJuego.higieneDePersonaje().modificarCantidad(-10)})
//		game.onTick(20000, "modifica salud cada 20 segundos", {stats.modificarSalud()})
		game.onTick(3000,"disminuye hambre cada 30 seg",{statsDelJuego.saciedadDePersonaje().modificarCantidad(-10)})
