...
object statsDelJuego {
	...
	const property humorDePersonaje = new Stat (cantidad = 20,x=14,y=14,buenaImagen="feliz.jpg",mediaImagen="neutral.jpg",malaImagen="triste.jpg")
	const property higieneDePersonaje = new Stat (cantidad=20,x=14,y=13,buenaImagen="buenasalud.jpg",mediaImagen="malaSalud.jpg",malaImagen="malaSalud.jpg")
...
object coronavirusDePersonaje{
	...
	method cuarentena(){		
		game.onTick(20000, "cuarentena", {contagiado = false game.addVisual(living.salida()) game.removeTickEvent("cuarentena")})	 
	}
    method visual(){
